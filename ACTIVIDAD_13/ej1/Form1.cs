namespace ej1
{
    public partial class Form1 : Form
    {
        ...
        {
            int numeroLote = nuevoLote.VerNumeroLote();
            if (numeroLote == 0)
            {
                int lote = Convert.ToInt32(tbAsignarNumeroLote.Text);
                nuevoLote.AsignarNumeroLote(lote);
            }
        }
